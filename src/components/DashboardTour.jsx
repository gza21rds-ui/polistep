...
export default function DashboardTour({ run, onFinish }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      content: '活動の目標期日までに必要な「訪問件数」や「ビラ配布枚数」の目標を設定します。右上の「目標再設定」からいつでも変更でき、期日までの「1日あたりの必要ノルマ」が自動計算されます！',
    },
    {
    ...
    },
    {
      ...
      title: '🔗 4. スタッフへマップを共有！',
      content: '表示されているURLをLINEやメールでボランティア・活動スタッフに共有するだけ！スタッフは面倒な会員登録なしで、スマホの地図からすぐに活動を記録できます。',
    },
    {
      target: '#tour-timeline',
      title: '⚡ 5. 現場の声をリアルタイム確認！',
      content: 'スタッフが現場で記録したお名前や対話メモがリアルタイムに届きます。過去のメモはお名前やキーワードでいつでも検索可能です。',
    },
    {
      target: '#tour-action-button',
      title: '🚀 6. マップを開いて活動開始！',
      content: 'ご自身やスタッフが現場に出る際は、ここからマップを開いてスマホのGPS連動でピンを打っていきましょう！',
    },
  ];
